...
function checkCompactDocs() {
  ...
  if (forbidden.length === 0) ok('No extra 2.1.3 docs found; compact documentation rule preserved.');
...
function checkStoreFastTrackMode() {
  ...
  warn('Store fast-track is informational only in 2.1.3: no 12-tester dependency is required for device-beta APK.');
}
...
console.log('');
console.log('BauBook 2.1.3 No-Store Device Launch readiness');
