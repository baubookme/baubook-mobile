...
const TARGET_APP_VERSION = '0.6.0';
const TARGET_BASELINE = '2.3.0';
...
function checkCompactDocs() {
  ...
  if (forbidden.length === 0) ok('No extra 2.3.0 docs found; compact documentation rule preserved.');
...
function checkStoreFastTrackMode() {
  ...
  warn('Store fast-track is informational only in 2.3.0: no 12-tester dependency is required for device-beta APK.');
}
...
console.log('');
console.log('BauBook 2.3.0 No-Store Device Launch readiness');
