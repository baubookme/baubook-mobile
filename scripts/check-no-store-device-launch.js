...
function checkCompactDocs() {
  ...
  if (forbidden.length === 0) ok('No extra 2.1.2 docs found; compact documentation rule preserved.');
...
function checkStoreFastTrackMode() {
  ...
  warn('Store fast-track is informational only in 2.1.2: no 12-tester dependency is required for device-beta APK.');
}
...
console.log('');
console.log('BauBook 2.1.2 No-Store Device Launch readiness');
