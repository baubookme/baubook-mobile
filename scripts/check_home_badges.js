...
function main() {
  ...
  assert(pkg.version === "0.3.9", "package.json version attesa 0.3.9.");
  assert(app.expo.version === "0.3.9", "app.json expo.version attesa 0.3.9.");
  assert(Number(app.expo.android.versionCode) >= 20, "app.json android.versionCode atteso >= 20.");
  assert(Number(app.expo.ios.buildNumber) >= 20, "app.json ios.buildNumber atteso >= 20.");
