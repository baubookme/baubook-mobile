...
-- Pack / Branco: expose the dog owner's visible username in Dog Friends search/list results.
-- UI uses owner display name plus max 3 dog sociality tags instead of a fixed fallback label.
